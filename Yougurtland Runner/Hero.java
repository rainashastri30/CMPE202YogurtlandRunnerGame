...
public class Hero extends Actor implements ScoreSubject
{
    ...
    public void act() 
    {
        ...
        if(Greenfoot.isKeyDown("up") && jumpCounter < 70){
            hero = jumpingHero;
            hero.movement(this);
            incrementCounter();
        } else if(getY() < 440){
        ...
        if((getOneObjectAtOffset(1,1,ObstaclePlant.class)!=null)||
        (getOneObjectAtOffset(-1,-1,ObstaclePlant.class)!=null)||
        (getOneObjectAtOffset(1,-1,ObstaclePlant.class)!=null)||
        (getOneObjectAtOffset(-1,1,ObstaclePlant.class)!=null)||
        ...
        }if((getOneObjectAtOffset(1,1,ObstacleFence.class)!=null)||
